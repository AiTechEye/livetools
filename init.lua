...
print(dump(livetools.pvp))

minetest.register_craftitem("livetools:obsidian_mix", {description = "Obsidian mix",inventory_image = "default_coal_lump.png^[colorize:#45770099",})
minetest.register_craftitem("livetools:liveobsidian", {description = "Living obsidian crystal",inventory_image = "default_coal_lump.png^[colorize:#458833ff",})
...
minetest.register_tool("livetools:pick", {
	...
	range = 13,
	inventory_image = "default_tool_diamondpick.png^[colorize:#8aff0055",
	on_use = function(itemstack, user, pointed_thing)
		if livetools.pvp==false and pointed_thing.type=="object" and pointed_thing.ref:is_player() then return itemstack end
